...
# GitHub
export GITHUB_CONNECTION_ARN=arn:aws:codestar-connections:ap-south-1:140857882741:connection/4c43c5a0-6ac9-417b-8d51-7bbc0c0822ad
export GITHUB_REPO=ishak0604/ECSCpuTest
export BRANCH=main

# Artifacts
export ARTIFACT_BUCKET=ecs-cpu-artifacts-123456789
